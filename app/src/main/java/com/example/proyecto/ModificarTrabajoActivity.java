...
public class ModificarTrabajoActivity extends AppCompatActivity {
        ...
        if(!TextUtils.isEmpty(act) || !TextUtils.isEmpty(des)) {
            ...
            miRef.putFile(FILEBMP).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(ModificarTrabajoActivity.this, "Exito al subir",
                            Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(ModificarTrabajoActivity.this, "Error al subir",
                            Toast.LENGTH_SHORT).show();
                }
            });
